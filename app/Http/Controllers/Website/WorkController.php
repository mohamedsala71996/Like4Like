...
class WorkController extends Controller
{
    ...
    { 
        ...
        $seenVideos=SeenVideo::where('customer_id',auth()->guard('customer')->id())->whereDate('day_date','=',$todayDate)->pluck('video_id')->toArray();
       // dd($seenVideos);
        $promotionalVideo = PromotionalVideo::whereNotIn('id',$seenVideos)->orderBy('id','ASC')->first();
        return view('webSite.work.index', compact('works','promotionalVideo')); 
    } 
